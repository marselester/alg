...
The classic [Bellman-Ford](https://godoc.org/github.com/marselester/alg/digraph/spt#BellmanFord)
algorithm for use in the general case, when cycles may be present, edge weights may be negative,
