...
func ExampleBellmanFord() {
	...
	g.Add(&weighted.Edge{6, 2, -1.20})
	g.Add(&weighted.Edge{3, 6, 0.52})
	g.Add(&weighted.Edge{6, 0, -1.40})
	g.Add(&weighted.Edge{6, 4, -1.25})
	...
	// Output:
	// 0 to 0: []
	// 0 to 1: [0->2 0.26 2->7 0.34 7->3 0.39 3->6 0.52 6->4 -1.25 4->5 0.35 5->1 0.32]
	// 0 to 2: [0->2 0.26]
	// 0 to 3: [0->2 0.26 2->7 0.34 7->3 0.39]
	// 0 to 4: [0->2 0.26 2->7 0.34 7->3 0.39 3->6 0.52 6->4 -1.25]
	// 0 to 5: [0->2 0.26 2->7 0.34 7->3 0.39 3->6 0.52 6->4 -1.25 4->5 0.35]
